...
var browserifyJsTest_BrowserifyTest = function() { };
browserifyJsTest_BrowserifyTest.__name__ = true;
browserifyJsTest_BrowserifyTest.main = function() {
	...
	b.bundle(function(err,src) {
		...
		console.log("hx/test/browserifyJsTest/BrowserifyTest.hx:22:",str);
		...
		console.log("hx/test/browserifyJsTest/BrowserifyTest.hx:25:","success!");
		return str;
	});
};
...
browserifyJsTest_BrowserifyTest.main();
})({});
